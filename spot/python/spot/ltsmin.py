...
class model(object):
    ...
    def kripke_raw(self, *args) -> "spot::kripke_ptr":
        return _ltsmin.model_kripke_raw(self, *args)

    def state_size(self) -> "int":
        return _ltsmin.model_state_size(self)

    def state_variable_name(self, var: 'int') -> "char const *":
        return _ltsmin.model_state_variable_name(self, var)

    def state_variable_type(self, var: 'int') -> "int":
        return _ltsmin.model_state_variable_type(self, var)

    def type_count(self) -> "int":
        return _ltsmin.model_type_count(self)

    def type_name(self, type: 'int') -> "char const *":
        return _ltsmin.model_type_name(self, type)

    def type_value_count(self, type: 'int') -> "int":
        return _ltsmin.model_type_value_count(self, type)

    def type_value_name(self, type: 'int', val: 'int') -> "char const *":
        return _ltsmin.model_type_value_name(self, type, val)
