...
#define YY_NEW_FILE hoayyrestart(yyin ,yyscanner )
...
#define YY_BUFFER_NORMAL 1
	 ...
	 * (via hoayyrestart()), so that the user can continue scanning by
...
void hoayyrestart (FILE *input_file ,yyscan_t yyscanner );
void hoayy_switch_to_buffer (YY_BUFFER_STATE new_buffer ,yyscan_t yyscanner );
YY_BUFFER_STATE hoayy_create_buffer (FILE *file,int size ,yyscan_t yyscanner );
void hoayy_delete_buffer (YY_BUFFER_STATE b ,yyscan_t yyscanner );
void hoayy_flush_buffer (YY_BUFFER_STATE b ,yyscan_t yyscanner );
void hoayypush_buffer_state (YY_BUFFER_STATE new_buffer ,yyscan_t yyscanner );
void hoayypop_buffer_state (yyscan_t yyscanner );

static void hoayyensure_buffer_stack (yyscan_t yyscanner );
static void hoayy_load_buffer_state (yyscan_t yyscanner );
static void hoayy_init_buffer (YY_BUFFER_STATE b,FILE *file ,yyscan_t yyscanner );

#define YY_FLUSH_BUFFER hoayy_flush_buffer(YY_CURRENT_BUFFER ,yyscanner)

YY_BUFFER_STATE hoayy_scan_buffer (char *base,yy_size_t size ,yyscan_t yyscanner );
YY_BUFFER_STATE hoayy_scan_string (yyconst char *yy_str ,yyscan_t yyscanner );
YY_BUFFER_STATE hoayy_scan_bytes (yyconst char *bytes,int len ,yyscan_t yyscanner );

void *hoayyalloc (yy_size_t ,yyscan_t yyscanner );
void *hoayyrealloc (void *,yy_size_t ,yyscan_t yyscanner );
void hoayyfree (void * ,yyscan_t yyscanner );

#define yy_new_buffer hoayy_create_buffer

#define yy_set_interactive(is_interactive) \
	{ \
	if ( ! YY_CURRENT_BUFFER ){ \
        hoayyensure_buffer_stack (yyscanner); \
		YY_CURRENT_BUFFER_LVALUE =    \
            hoayy_create_buffer(yyin,YY_BUF_SIZE ,yyscanner); \
	} \
...
static yyconst flex_uint16_t yy_base[402] =
    {   0,
...
int hoayylex_init (yyscan_t* scanner);

int hoayylex_init_extra (YY_EXTRA_TYPE user_defined,yyscan_t* scanner);

/* Accessor methods to globals.
   These are made visible to non-reentrant scanners for convenience. */

int hoayylex_destroy (yyscan_t yyscanner );

int hoayyget_debug (yyscan_t yyscanner );

void hoayyset_debug (int debug_flag ,yyscan_t yyscanner );

YY_EXTRA_TYPE hoayyget_extra (yyscan_t yyscanner );

void hoayyset_extra (YY_EXTRA_TYPE user_defined ,yyscan_t yyscanner );

FILE *hoayyget_in (yyscan_t yyscanner );

void hoayyset_in  (FILE * _in_str ,yyscan_t yyscanner );

FILE *hoayyget_out (yyscan_t yyscanner );

void hoayyset_out  (FILE * _out_str ,yyscan_t yyscanner );

			int hoayyget_leng (yyscan_t yyscanner );

char *hoayyget_text (yyscan_t yyscanner );

int hoayyget_lineno (yyscan_t yyscanner );

void hoayyset_lineno (int _line_number ,yyscan_t yyscanner );

int hoayyget_column  (yyscan_t yyscanner );

void hoayyset_column (int _column_no ,yyscan_t yyscanner );
...
#ifdef __cplusplus
extern "C" int hoayywrap (yyscan_t yyscanner );
#else
extern int hoayywrap (yyscan_t yyscanner );
#endif
#endif
...
extern int hoayylex (yyscan_t yyscanner);

#define YY_DECL int hoayylex (yyscan_t yyscanner)
#endif /* !YY_DECL */
...
YY_DECL
{
	...
	if ( !yyg->yy_init )
		...
		hoayy_load_buffer_state(yyscanner );
		}
	...
	case YY_END_OF_BUFFER:
		...
		*yy_cp = yyg->yy_hold_char;
		...
		if ( YY_CURRENT_BUFFER_LVALUE->yy_buffer_status == YY_BUFFER_NEW )
			 ...
			 * hoayylex().  If so, then we have to assure
...
static int yy_get_next_buffer (yyscan_t yyscanner)
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					hoayyrealloc((void *) b->yy_ch_buf,b->yy_buf_size + 2 ,yyscanner );
				}
			else
	...
	if ((yyg->yy_n_chars + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) hoayyrealloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,new_size ,yyscanner );
    ...
    void hoayyrestart  (FILE * input_file , yyscan_t yyscanner)
{
	...
	hoayy_init_buffer(YY_CURRENT_BUFFER,input_file ,yyscanner);
	hoayy_load_buffer_state(yyscanner );
}
    ...
    void hoayy_switch_to_buffer  (YY_BUFFER_STATE  new_buffer , yyscan_t yyscanner)
{
	 ...
	 * with
	 *		hoayypop_buffer_state();
	 *		hoayypush_buffer_state(new_buffer);
     */
	hoayyensure_buffer_stack (yyscanner);
	 ...
	 * EOF (hoayywrap()) processing, but the only time this flag
	 * is looked at is after hoayywrap() is called, so it's safe
    ...
    YY_BUFFER_STATE hoayy_create_buffer  (FILE * file, int  size , yyscan_t yyscanner)
{
	...
	b = (YY_BUFFER_STATE) hoayyalloc(sizeof( struct yy_buffer_state ) ,yyscanner );
	if ( ! b )
		YY_FATAL_ERROR( "out of dynamic memory in hoayy_create_buffer()" );
	 ...
	 */
	b->yy_ch_buf = (char *) hoayyalloc(b->yy_buf_size + 2 ,yyscanner );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in hoayy_create_buffer()" );

	b->yy_is_our_buffer = 1;

	hoayy_init_buffer(b,file ,yyscanner);

	return b;
}

/** Destroy the buffer.
 * @param b a buffer created with hoayy_create_buffer()
 * @param yyscanner The scanner object.
 */
    void hoayy_delete_buffer (YY_BUFFER_STATE  b , yyscan_t yyscanner)
{
	...
	if ( b->yy_is_our_buffer )
		hoayyfree((void *) b->yy_ch_buf ,yyscanner );

	hoayyfree((void *) b ,yyscanner );
}

/* Initializes or reinitializes a buffer.
 * This function is sometimes called more than once on the same buffer,
 * such as during a hoayyrestart() or at EOF.
 */
    static void hoayy_init_buffer  (YY_BUFFER_STATE  b, FILE * file , yyscan_t yyscanner)

{
	...
	hoayy_flush_buffer(b ,yyscanner);

	b->yy_input_file = file;
	b->yy_fill_buffer = 1;

    /* If b is the current buffer, then hoayy_init_buffer was _probably_
     * called from hoayyrestart() or through yy_get_next_buffer.
...
void hoayypush_buffer_state (YY_BUFFER_STATE new_buffer , yyscan_t yyscanner)
{
	...
	/* This block is copied from hoayy_switch_to_buffer. */
	if ( YY_CURRENT_BUFFER )
		{
		/* Flush out information for old buffer. */
		*yyg->yy_c_buf_p = yyg->yy_hold_char;
	...
	/* copied from hoayy_switch_to_buffer. */
	hoayy_load_buffer_state(yyscanner );
	yyg->yy_did_buffer_switch_on_eof = 1;
}
...
void hoayypop_buffer_state (yyscan_t yyscanner)
{
	...
	hoayy_delete_buffer(YY_CURRENT_BUFFER ,yyscanner);
...
static void hoayyensure_buffer_stack (yyscan_t yyscanner)
{
	...
	if (!yyg->yy_buffer_stack) {
      ...
      num_to_alloc = 1; /* After all that talk, this was set to 1 anyways... */
		yyg->yy_buffer_stack = (struct yy_buffer_state**)hoayyalloc
								(num_to_alloc * sizeof(struct yy_buffer_state*)
								, yyscanner);
		if ( ! yyg->yy_buffer_stack )
			YY_FATAL_ERROR( "out of dynamic memory in hoayyensure_buffer_stack()" );
	...
	if (yyg->yy_buffer_stack_top >= (yyg->yy_buffer_stack_max) - 1){
		...
		yyg->yy_buffer_stack = (struct yy_buffer_state**)hoayyrealloc
								(yyg->yy_buffer_stack,
								num_to_alloc * sizeof(struct yy_buffer_state*)
								, yyscanner);
		if ( ! yyg->yy_buffer_stack )
...
YY_BUFFER_STATE hoayy_scan_buffer  (char * base, yy_size_t  size , yyscan_t yyscanner)
{
	...
	b = (YY_BUFFER_STATE) hoayyalloc(sizeof( struct yy_buffer_state ) ,yyscanner );
	if ( ! b )
		YY_FATAL_ERROR( "out of dynamic memory in hoayy_scan_buffer()" );
	...
	hoayy_switch_to_buffer(b ,yyscanner );

	return b;
}

/** Setup the input buffer state to scan a string. The next call to hoayylex() will
 * scan from a @e copy of @a str.
 * @param yystr a NUL-terminated string to scan
 * @param yyscanner The scanner object.
 * @return the newly allocated buffer state object.
 * @note If you want to scan bytes that may contain NUL values, then use
 *       hoayy_scan_bytes() instead.
 */
YY_BUFFER_STATE hoayy_scan_string (yyconst char * yystr , yyscan_t yyscanner)
{
    
	return hoayy_scan_bytes(yystr,(int) strlen(yystr) ,yyscanner);
}

/** Setup the input buffer state to scan the given bytes. The next call to hoayylex() will
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE hoayy_scan_bytes  (yyconst char * yybytes, int  _yybytes_len , yyscan_t yyscanner)
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
	...
	buf = (char *) hoayyalloc(n ,yyscanner );
	if ( ! buf )
		YY_FATAL_ERROR( "out of dynamic memory in hoayy_scan_bytes()" );
	...
	b = hoayy_scan_buffer(buf,n ,yyscanner);
	if ( ! b )
		YY_FATAL_ERROR( "bad buffer in hoayy_scan_bytes()" );
...
void hoayyset_lineno (int  _line_number , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
        ...
        if (! YY_CURRENT_BUFFER )
           YY_FATAL_ERROR( "hoayyset_lineno called with no buffer" );
...
void hoayyset_column (int  _column_no , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
        ...
        if (! YY_CURRENT_BUFFER )
           YY_FATAL_ERROR( "hoayyset_column called with no buffer" );
...
void hoayyset_debug (int  _bdebug , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
...
/* hoayylex_init is special because it creates the scanner itself, so it is
 * the ONLY reentrant function that doesn't take the scanner as the last argument.
 * That's why we explicitly handle the declaration, instead of using our macros.
 */

int hoayylex_init(yyscan_t* ptr_yy_globals)

{
    ...
    *ptr_yy_globals = (yyscan_t) hoayyalloc ( sizeof( struct yyguts_t ), NULL );
...
/* hoayylex_init_extra has the same functionality as hoayylex_init, but follows the
 * convention of taking the scanner as the last argument. Note however, that
 * this is a *pointer* to a scanner, as it will be allocated by this call (and
 * is the reason, too, why this function also must handle its own declaration).
 * The user defined value in the first argument will be available to hoayyalloc in
 * the yyextra field.
 */

int hoayylex_init_extra(YY_EXTRA_TYPE yy_user_defined,yyscan_t* ptr_yy_globals )

{
    struct yyguts_t dummy_yyguts;

    hoayyset_extra (yy_user_defined, &dummy_yyguts);
    ...
    *ptr_yy_globals = (yyscan_t) hoayyalloc ( sizeof( struct yyguts_t ), &dummy_yyguts );
    ...
    hoayyset_extra (yy_user_defined, *ptr_yy_globals);
...
static int yy_init_globals (yyscan_t yyscanner)
{
     ...
     * This function is called from hoayylex_destroy(), so don't allocate here.
     */
...
/* hoayylex_destroy is for both reentrant and non-reentrant scanners. */
int hoayylex_destroy  (yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
	...
	while(YY_CURRENT_BUFFER){
		hoayy_delete_buffer(YY_CURRENT_BUFFER ,yyscanner );
		YY_CURRENT_BUFFER_LVALUE = NULL;
		hoayypop_buffer_state(yyscanner);
	}

	/* Destroy the stack itself. */
	hoayyfree(yyg->yy_buffer_stack ,yyscanner);
	yyg->yy_buffer_stack = NULL;

    /* Destroy the start condition stack. */
        hoayyfree(yyg->yy_start_stack ,yyscanner );
        yyg->yy_start_stack = NULL;

    /* Reset the globals. This is important in a non-reentrant scanner so the next time
     * hoayylex() is called, initialization will occur. */
    yy_init_globals( yyscanner);

    /* Destroy the main struct (reentrant only). */
    hoayyfree ( yyscanner , yyscanner );
    yyscanner = NULL;
    return 0;
}
...
void *hoayyalloc (yy_size_t  size , yyscan_t yyscanner)
{
	struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
	(void)yyg;
	return malloc(size);
...
void *hoayyrealloc  (void * ptr, yy_size_t  size , yyscan_t yyscanner)
{
	struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
	(void)yyg;
...
void hoayyfree (void * ptr , yyscan_t yyscanner)
{
	struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
	(void)yyg;
	free( (char *) ptr );	/* see hoayyrealloc() for (char *) cast */
}
...
namespace spot
{
  ...
  {
    hoayylex_init_extra(new extra_data,scanner);
  ...
  {
    hoayylex_init_extra(new extra_data,scanner);
    hoayy_scan_string(data,*scanner);
    return 0;
  }
