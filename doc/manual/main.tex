...
\vspace*{5cm}
{\Huge The Property Language Manual \\[8pt]}
{\Large Model Checking Contest @ Petri Nets 2015}

\vfill
~~
\hfill
{\scriptsize v\@. Feb. 6, 2015}
...
Each category designates the
name of a XML file providing, for every benchmark, a set of formulæ for
tools competing in this category to solve.
...
Tools participating in this category will only find one formula to solve
for every benchmark:
...
Tools participating in this category will only find two kinds of
...
while the formulas in the \emph{ReachabilityCardinality} category uniquely
contain integer inequalities:
