...
found. Overall, we propose 9 subcategories:
...
%
The 9 subcategories proposed this year were already proposed last
...
\textit{ReachabilityComputeBounds} employs \textit{bound formulas}, all other
...
\section{Rules Concerning the ReachabilityComputeBounds category}
...
ReachabilityComputeBounds we have $n \in N$ answers from $n$ different tools.
